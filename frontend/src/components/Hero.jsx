...
const Hero = () => (
    <div className = "bg-slate-100 w-full relative overflow-x-hidden">  {/* flex flex-row  */}  
        ...
        <div className="pt-10 flex flex-col md:flex-row justify-between"> {/* container max-w-lg mx-auto grid grid-cols-1 lg:grid-cols-1 grid-flow-row auto-rows-max*/}
            <div className="flex flex-col py-10 pl-20 flex-grow-0">  {/* col-span-1 lg:col-span-1 */}
            ...
            <div className = "flex pl-10 hero-bg-image w-1/2">    
