    ...
    <div className = "flex w-full bg-secondary-green py-8 overflow-x-hidden">   
        <div className="container mx-auto flex justify-between items-center flex-grow-0 flex-col lg:flex-row">   
            ...
            <div className="flex-grow h-full mx-2 flex justify-center items-center gap-x-12 my-10 flex-wrap md:flex-nowrap gap-y-4">    
                <div className = "rounded-lg bg-primary-green text-white px-3 py-8 max-w-xs shadow-sm shadow-slate-400 w-[220px] transition-all duration-200 hover:shadow-[2px_2px_5px_rgba(0,0,0,.6)] hover:shadow-md hover:scale-105 hover:bg-[#27e36c]">    
                ...
                <div className = "rounded-lg bg-primary-green text-white px-3 py-8 max-w-xs shadow-sm shadow-slate-400 w-[220px] transition-all duration-200 hover:shadow-[2px_2px_5px_rgba(0,0,0,.6)] hover:shadow-md hover:scale-105 hover:bg-[#27e36c]">  
                    ...
                    <p className = "font-semibold text-center text-sm">Explore and Showcase your Unique skills. Find the perfect match for your talents</p>
                </div>
