            ...
            <div className="container mx-auto h-auto py-10 border-t">   
                ...
                <div className="blogs flex justify-center items-center gap-6 mt-10 flex-wrap">  
                    ...
                    {blogs && blogs.map((blog,i) => (
                        <div className = "flex flex-col gap-y-5 rounded-md px-5 py-3 border-2 max-w-md min-w-[150px] shadow-[0px_0px_0px] hover:shadow-green-500 hover:shadow-[5px_5px_0px] transition-all duration-200 cursor-pointer" key = {i}>      
                            <h2 className="text-lg text-center font-bold font-inter">{blog.title}</h2> 
                            <h3 className="text-center font-inter">{blog.content}</h3>
